    ...
    <div className="rounded-3xl bg-white/6 border border-white/10 p-5 hover:bg-white/8 transition">
      ...
      <div className="mt-4 flex items-center justify-between text-sm">
        <div className="text-white/75">
          Experience: <span className="text-white">{job.exp}</span>
        </div>
        ...
        <button
          onClick={() =>
            window.open(
              "https://forms.gle/CmwzVhw5sD1ayYue8",
              "_blank",
              "noopener,noreferrer"
            )
          }
          className="px-4 py-2 rounded-full bg-indigo-600 border border-indigo-500 text-white hover:bg-indigo-700 transition"
        >
          Apply Now
        </button>
      </div>
